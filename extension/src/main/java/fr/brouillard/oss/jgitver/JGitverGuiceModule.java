...
//    bind(JGitverConfiguration.class).to(JGitverConfigurationComponent.class).in(Scopes.SINGLETON);
//    bind(JGitverExecutionInformationProvider.class).to(JGitverExecutionInformationProviderImpl.class).in(Scopes.SINGLETON);
  }
}
