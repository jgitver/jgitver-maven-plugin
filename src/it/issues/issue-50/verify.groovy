...
def versionChanges = buildLog.findAll { it =~ /fr.brouillard.oss.it::issue-50::0 -> 1.0.0/ }
...
URL jarFileURL = new File(basedir, "target/issue-50-1.0.0.jar").toURI().toURL()
URL pomInJar = new URL("jar:" + jarFileURL + "!/META-INF/maven/fr.brouillard.oss.it/issue-50/pom.xml")
