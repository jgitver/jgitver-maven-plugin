...
def versionChanges = buildLog.findAll { it =~ /fr.brouillard.oss.it::issue-98-merges::0 -> 2.0.1-3/ }
...
File installedPomFile = new File(localRepositoryPath, "fr/brouillard/oss/it/issue-98-merges/2.0.1-3/issue-98-merges-2.0.1-3.pom")
log.println( "installedPomFile: " + installedPomFile.isFile() + " " + installedPomFile )
assert installedPomFile.isFile()
def installedPomFileVersion = installedPomFile.readLines().findAll { it =~ /<version>2.0.1-3<\/version>/ }
