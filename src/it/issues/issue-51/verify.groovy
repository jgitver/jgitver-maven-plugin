...
def versionChanges = buildLog.findAll { it =~ /fr.brouillard.oss.it::issue-51::0 -> 1.0.0-my-branch/ }
...
File installedPomFile = new File(localRepositoryPath, "fr/brouillard/oss/it/issue-51/1.0.0-my-branch/issue-51-1.0.0-my-branch.pom")
log.println( "installedPomFile: " + installedPomFile.isFile() + " " + installedPomFile )
assert installedPomFile.isFile()
def installedPomFileVersion = installedPomFile.readLines().findAll { it =~ /<version>1.0.0-my-branch<\/version>/ }
