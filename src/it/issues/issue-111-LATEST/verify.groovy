...
def versionChanges = buildLog.findAll { it =~ /fr.brouillard.oss.it::issue-98-merges::0 -> 1.1.1-2/ }
...
File installedPomFile = new File(localRepositoryPath, "fr/brouillard/oss/it/issue-98-merges/1.1.1-2/issue-98-merges-1.1.1-2.pom")
log.println( "installedPomFile: " + installedPomFile.isFile() + " " + installedPomFile )
assert installedPomFile.isFile()
def installedPomFileVersion = installedPomFile.readLines().findAll { it =~ /<version>1.1.1-2<\/version>/ }
