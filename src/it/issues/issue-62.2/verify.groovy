...
def versionChanges = buildLog.findAll { it =~ /fr.brouillard.oss.it::issue-62.2::0 -> 0.0.0-SNAPSHOT/ }
log.println( "versionChanges: " + versionChanges )
assert 0 < versionChanges.size()

// Check the dirty==true profile has not been activated
