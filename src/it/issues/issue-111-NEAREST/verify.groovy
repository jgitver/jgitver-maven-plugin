...
def versionChanges = buildLog.findAll { it =~ /fr.brouillard.oss.it::issue-98-merges::0 -> 1.0.1-1/ }
...
File installedPomFile = new File(localRepositoryPath, "fr/brouillard/oss/it/issue-98-merges/1.0.1-1/issue-98-merges-1.0.1-1.pom")
