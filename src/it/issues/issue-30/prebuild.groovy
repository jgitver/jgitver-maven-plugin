...
[
  ...
  "javac outside/IntSetBuilder.java",
  "jar cvf outside.jar outside",
  "mvn install:install-file -DlocalRepositoryPath="+localRepositoryPath
  + " -Dfile=outside.jar -Dpackaging=jar -DgeneratePom=false"
  + " -DgroupId=fr.brouillard.oss.it -DartifactId=int-set-builder -Dversion=0.4"
