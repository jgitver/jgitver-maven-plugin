...
// Check the dirty state lead to an Exception
def exceptionDetected = buildLog.findAll { it =~ /java.lang.IllegalStateException: repository is dirty/ }
assert 0 < exceptionDetected.size()
